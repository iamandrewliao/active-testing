...
def main(args):
    ...
    # --- Generate full design space ---
    # Used by 'iid', 'brute_force', and 'active' modes (not for 'loaded' since points come from a file)
    points = None
    if args.mode in ['iid', 'brute_force', 'active']:
        # 1. Generate full design space
    ...
    for i in range(loop_start_index, args.num_evals):
        ...
        # Use continuous_outcome for the surrogate model
